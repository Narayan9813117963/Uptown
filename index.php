...
<main>
    <div class="hero-bg">
        <section class="banner section-pad">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="banner-text">
                            ...
                            <a href="#" class="button-1">Look menu</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <figure>
...
<section class="about-why-wrapper">
    <div class="container">
                    ...
                    <div class="testi-card">
                        <div class="slider-1 position-relative">
                            <div class="testi-1">
                                ...
                                <p class="pt-3">It is a long established fact that a reader will be distracted by
...
<section class="store-contact-us position-relative">
    ...
    <div class="contact-us section-pad">
        <div class="container">
            <div class="custom-container-sm">
                <div class="row">
                    <div class="col-lg-7 d-md-flex justify-content-md-center">
                        <form action="submit">
                            ...
                            <div class="contact-input position-relative d-flex flex-column text-area">
                                ...
                                <a class="position-absolute bottom-0 end-0 px-2 py-2" href="#"><img
                                        src="images/icons/email-send.svg" alt="email-send"></a>
                            </div>
                            <div class="terms">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="contact-wrapper flex-column d-flex gap-5 ">
                            ...
                            <div class="contact-btn">
                                <a href="#" class="button-1">Request a call</a>
                            </div>
                        </div>
                    </div>
                </div>
