                  ...
                  <div class="col-lg-4 d-none d-lg-block ">
                    <div class="contact-head d-flex align-items-center justify-content-end gap-3">
                      <div class="links d-flex gap-3">
                        ...
                        ></a>
                        <a href="#" aria-level="Instagram"><i class="bi bi-instagram"></i
                        ></a>
                      </div>
                    ...
                    <div class=" col-3 col-md-3 col-lg-2 toggler-btn justify-content-end">
                      ...
                      <a class="" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                        ...
                        <div class="offcanvas offcanvas-start hidden-nav" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
